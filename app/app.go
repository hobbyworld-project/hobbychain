...
import (
	...
	"github.com/hobbyworld-project/hobbychain/docs"
	...
	"github.com/hobbyworld-project/hobbychain/app/ante"
)
...
type App struct {
	*baseapp.BaseApp
	...
	HobbyKeeper hobbymodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		hobbymoduletypes.StoreKey, nftkeeper.StoreKey, ibcfeetypes.StoreKey,
		// this line is used by starport scaffolding # stargate/app/storeKey

		// ethermint keys
		evmtypes.StoreKey, feemarkettypes.StoreKey, claimstypes.StoreKey, erc20types.StoreKey,
	)
	...
	*/
	...
	app.HobbyKeeper = *hobbymodulekeeper.NewKeeper(
		appCodec,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(hobbymoduletypes.ModuleName)
