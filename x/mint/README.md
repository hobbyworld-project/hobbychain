...
```shell
/coues.mint.v1beta1.Query/AnnualProvisions
```

Example:

```shell
grpcurl -plaintext localhost:9090 coues.mint.v1beta1.Query/AnnualProvisions
```
...
```shell
/coues.mint.v1beta1.Query/Inflation
```

Example:

```shell
grpcurl -plaintext localhost:9090 coues.mint.v1beta1.Query/Inflation
```
...
```shell
/coues.mint.v1beta1.Query/Params
```

Example:

```shell
grpcurl -plaintext localhost:9090 coues.mint.v1beta1.Query/Params
```
...
```shell
/hobby/mint/v1beta1/annual_provisions
```

Example:

```shell
curl "localhost:1317/hobby/mint/v1beta1/annual_provisions"
```
...
```shell
/hobby/mint/v1beta1/inflation
```

Example:

```shell
curl "localhost:1317/hobby/mint/v1beta1/inflation"
```
...
```shell
/hobby/mint/v1beta1/params
```

Example:

```shell
curl "localhost:1317/hobby/mint/v1beta1/params"
```
